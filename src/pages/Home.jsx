    ...
    <div className='h-[680px] relative flex flex-row  w-full mb-8'>
      ...
      <div className='bg-whitey2 flex h-[500px] w-full p-2'>
        <div className='mx-auto my-auto gap-16 flex'>
          <img src='src/assets/Frame 3.png' className='w-[270px] h-[448px]'></img>
          <img src='src/assets/Frame 4.png' className='w-[270px] h-[448px]'></img>
          <img src='src/assets/Frame 5.png' className='w-[270px] h-[448px]'></img>
          <img src='src/assets/Frame 6.png' className='w-[270px] h-[448px]'></img>
        </div>
      </div>
